...
public class TensorFlowObjectDetectionAPIModel implements Classifier {
     ...
     *
     * @param modelFileAddress The filepath of the model GraphDef protocol buffer.
     * @param labelFileAddress The filepath of label file for classes.
     */
    public static Classifier create(
            final String modelFileAddress,
            final String labelFileAddress,
            final int inputSize) throws IOException {
        Log.d(Constants.TAG, modelFileAddress + "," + labelFileAddress);
        final TensorFlowObjectDetectionAPIModel d = new TensorFlowObjectDetectionAPIModel();

        InputStream labelsInput = new FileInputStream(new File(labelFileAddress));
        ...
        d.inferenceInterface = new TensorFlowInferenceInterface(new FileInputStream(modelFileAddress));
